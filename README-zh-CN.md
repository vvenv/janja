...
- 🚀 **高性能**：LRU 缓存、预编译支持和优化的字符串处理。
- 🛡️ **增强的安全**：沙箱模式、CSP 支持、深度转义和安全审计工具。
- 📊 **丰富的过滤器库**：日期/时间、数字格式化、文本处理、数组操作、对象转换和异步过滤器。
...
- [使用文档](./documentation-zh-CN.md) - 核心文档
- [过滤器](./FILTERS.md) - 内置过滤器参考
